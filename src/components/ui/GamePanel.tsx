    ...
    <section className={cn('relative pt-7', className)}>
      ...
      <div className="absolute left-1/2 top-0 z-10 -translate-x-1/2">
        <div className="relative">
          ...
          />
          {/* Kurdelenin gövdesi */}
          <h2 className="relative whitespace-nowrap rounded-xl border-4 border-bark bg-gradient-to-b from-gold-2 to-gold-3 px-7 py-1.5 text-center text-xl font-extrabold uppercase tracking-wide text-stroked shadow-[0_5px_0_rgb(0_0_0/0.3)] sm:text-2xl">
            {title}
          </h2>
        </div>
      </div>

      <div className="panel-gold px-3 pb-4 pt-9 sm:px-4">
        {children}
